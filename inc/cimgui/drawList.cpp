...
CIMGUI_API ImDrawVert *ImDrawList_GetVertexBufferData(ImDrawList *list)
{
    return list->VtxBuffer.Data;
}
...
CIMGUI_API ImDrawIdx *ImDrawList_GetIndexBufferData(ImDrawList *list)
{
    return list->IdxBuffer.Data;
}
