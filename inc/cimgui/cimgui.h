...
CIMGUI_API struct ImDrawVert *ImDrawList_GetVertexBufferData(struct ImDrawList *list);
...
CIMGUI_API ImDrawIdx *ImDrawList_GetIndexBufferData(struct ImDrawList *list);
