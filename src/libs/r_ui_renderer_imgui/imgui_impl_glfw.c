...
//  [X] Platform: Keyboard arrays indexed using GLFW_KEY_* codes, e.g. igIsKeyPressed(GLFW_KEY_SPACE).
...
//  2018-02-20: Inputs: Added support for mouse cursors (igGetMouseCursor() value, passed to glfwSetCursor()).
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, enum GlfwClientApi client_api)
{
    g_Window = window;
    g_Time = 0.0;
...
void ImGui_ImplGlfw_NewFrame()
{
    ...
    glfwGetWindowSize((GLFWwindow*)g_Window, &w, &h);
    glfwGetFramebufferSize((GLFWwindow*)g_Window, &display_w, &display_h);
